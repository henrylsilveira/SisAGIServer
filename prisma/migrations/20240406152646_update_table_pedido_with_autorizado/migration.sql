...
INSERT INTO "new_PedidoViatura" ("apresentar", "chefeViatura", "companhia", "created_at", "dataDesejada", "dataDevolucao", "id", "intinerario", "militarIdPedido", "missao", "motorista", "observacao", "status") SELECT "apresentar", "chefeViatura", "companhia", "created_at", "dataDesejada", "dataDevolucao", "id", "intinerario", "militarIdPedido", "missao", "motorista", "observacao", "status" FROM "PedidoViatura";
