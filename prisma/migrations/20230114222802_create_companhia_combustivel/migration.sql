/*
  ...
  - Added the required column `companhia` to the `Combustivel` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Combustivel" ("combustivel_devolvido", "combustivel_pedido", "combustivel_usado", "data_devolucao", "data_missao", "id", "militarId", "missao", "nr_pedido", "status", "tipo_combustivel", "unidade") SELECT "combustivel_devolvido", "combustivel_pedido", "combustivel_usado", "data_devolucao", "data_missao", "id", "militarId", "missao", "nr_pedido", "status", "tipo_combustivel", "unidade" FROM "Combustivel";
