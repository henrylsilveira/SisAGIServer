...
INSERT INTO "new_PedidoViatura" ("apresentar", "chefeViatura", "created_at", "dataDesejada", "dataDevolucao", "id", "intinerario", "missao", "motorista", "observacao", "status") SELECT "apresentar", "chefeViatura", "created_at", "dataDesejada", "dataDevolucao", "id", "intinerario", "missao", "motorista", "observacao", "status" FROM "PedidoViatura";
